...
public class PlayerIdManager
{
    ...
    """;
    public static async UniTask<IEnumerable<Offense>> GetOffensesAsync(KronstadtPlayer player)
    {
        await using MySqlConnection connection = SqlManager.CreateConnection();
        await connection.OpenAsync();
    ...
    private static PlayerIdData GetPlayerIdData(KronstadtPlayer player)
    {
    ...
    """;
    private static async UniTask AddPlayer(KronstadtPlayer player, PlayerIdData data, MySqlConnection connection)
    {
