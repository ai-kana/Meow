...
public class CommandParser
{
    ...
    static CommandParser()
    {
        ...
        RegisterCommandParser(new KronstadtPlayerParser());
    ...
    private class KronstadtPlayerParser : ArgumentParser<KronstadtPlayer>
    {
        public override bool TryParse(IEnumerator<string> enumerator, out KronstadtPlayer result)
        {
            return KronstadtPlayerManager.TryFindPlayer(enumerator.Current, out result);
        }
    }
